...
class AppBhaskara():
    ...
    def frame_graph(self):
        self.frm = Frame(self.root_bhaskara, bg="red")
    ...
    def widgets(self):
        self.Label_a = Label(self.root_bhaskara, text="a:", font=self.fonte_padrao)
        self.Label_a.place(relx=0.05, rely=0.05)

        self.Label_b = Label(self.root_bhaskara, text="b:", font=self.fonte_padrao)
        self.Label_b.place(relx=0.05, rely=0.15)

        self.Label_c = Label(self.root_bhaskara, text="c:", font=self.fonte_padrao)
        self.Label_c.place(relx=0.05, rely=0.25)

        self.Entry_a = Entry(self.root_bhaskara, font=self.fonte_padrao)
        self.Entry_a.place(relx=0.2, rely=0.05, relheight=0.1, relwidth=0.3)

        self.Entry_b = Entry(self.root_bhaskara, font=self.fonte_padrao)
        self.Entry_b.place(relx=0.2, rely=0.15, relheight=0.1, relwidth=0.3)

        self.Entry_c = Entry(self.root_bhaskara, font=self.fonte_padrao)
        self.Entry_c.place(relx=0.2, rely=0.25, relheight=0.1, relwidth=0.3)

        self.btnCalcular = Button(self.root_bhaskara, text="Calcular", command=self.bhaskara_calc)
